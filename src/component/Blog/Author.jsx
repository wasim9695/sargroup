                                    ...
                                    <table class=" tab1 table table-bordered table table-flush" id="products-list">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="text-sm">
                                                    <img class="w-10 ms-3" src="https://raw.githubusercontent.com/creativetimofficial/public-assets/master/soft-ui-design-system/assets/img/ecommerce/adidas-hoodie.jpg" alt="hoodie"/></td>
                                                <td class="text-sm">Gender</td>
                                                <td class="text-sm">Age</td>
                                                <td class="text-sm">Qualification</td>
                                                <td class="text-sm">Occupation</td>
                                                <td class="text-sm">Organisation</td>
