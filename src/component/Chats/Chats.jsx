  ...
  return (
    <div>
            ...
            <div class="container-fluid py-4">
                <div class="row">
                    <div class="col-4">
                        <div class="card blur shadow-blur max-height-vh-70 overflow-auto overflow-x-hidden mb-5 mb-lg-0 cdA">
                            ...
                            <div class="card-body p-2"
                                ...
                                <a href="javascript:;" class="d-block p-2 border-radius-lg bg-gradient-secondary">
                    ...
                    <div class="col-8">
                        <div class="card blur shadow-blur max-height-vh-70 cdB">
