...
function Addmoneyseller() {
    return (
        <div>
            <div class="container-fluid py-5 col-md-10 ">
                <div class="col-lg-12 mt-lg-0 mt-4">
                    <h2>ADD Money to Seller Wallet</h2>
                    <div class="card ">
                        <div class="card-body">
                            <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                <label class="mt-4">Add Amount</label>
                                <input class="form-control" type="text" value="" placeholder=''/>
                            </div>
                            <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                <label class="mt-4">Display Seller Wallet Amount</label>
                                <input class="form-control" type="text" value="" placeholder=''/>
                            </div>
                            <div class="col-md-12">
