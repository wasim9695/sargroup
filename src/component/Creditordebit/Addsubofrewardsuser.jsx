                                    ...
                                    <table class=" tab1 table table-bordered table table-flush" id="products-list">
                                        <thead class="thead-light">
                                            <tr>
                                                ...
                                                <th>User Name</th>
                                                <th>Order Id</th>
                                                <th>Add Reward Amount</th>
                                                <th>Purpose</th>
                                                <th>Available Reward Amount</th>
                                                <th>Staff Id</th>
                                                <th>Staff Name</th>
                                                <th>Role</th>
                                                <th>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="text-sm">Add Reward Amount</td>
                                                <td class="text-sm">Purpose</td>
                                                <td class="text-sm">Available Reward Amount</td>
                                                <td class="text-sm">Staff Id</td>
                                                <td class="text-sm">Staff Name</td>
                                                <td class="text-sm">Role</td>
...
export default Addsubofrewardsuser
