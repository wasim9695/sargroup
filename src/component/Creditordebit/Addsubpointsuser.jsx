                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header pb-0">
                                <div class="d-lg-flex">
                                    <h2>User Points - Add/Subtract List</h2>
                                    <div class="ms-auto my-auto mt-lg-0 mt-4">
                                        <div class="ms-auto my-auto">
                                            <Link to="/admin/Addpointuse">
                                    ...
                                    <table class=" tab1 table table-bordered table table-flush" id="products-list">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="text-sm">Add Points</td>
                                                <td class="text-sm">Purpose</td>
                                                <td class="text-sm">Wallet</td>
                                                <td class="text-sm">Available Points</td>
...
export default Addsubpointsuser
