                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header pb-0">
                                    <div class="d-lg-flex">
                                        <h2>Default Transfer Hold History</h2>
                                        ...
                                        <table class=" tab1 table table-bordered table table-flush" id="products-list">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="text-sm">Date Of Transfer</td>
                                                    <td class="text-sm">DH Number</td>
