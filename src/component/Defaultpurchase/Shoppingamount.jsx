                                ...
                                <table class=" tab1 table table-bordered table table-flush" id="products-list">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="text-sm">Date Added</td>
                                            <td class="text-sm">Updated Date</td>
                                            <td class="text-sm">Selelr Detaisl</td>
                                            <td class="text-sm">Category <br /><span>Sub-Category</span><br /><span>Child Category</span></td>
                                            <td class="text-sm">Brand</td>
                                            <td class="text-sm">Product Id</td>
                                            <td class="text-sm">Product Name
                                                <br/><span>Size</span><br/><span>color</span>
                                            </td>
                                            <td class="text-sm">Qty</td>
                                            <td class="text-sm">Final Amount</td>
                                            <td class="text-sm">Discount Points
                                                <br/><span>Seller Discount</span><br/><span>Sponsor Comm</span></td>
                                                <td class="text-sm">Start Date</td>
                                                <td class="text-sm">End Date</td>
                                                <td class="text-sm">Total Days</td>
                                                <td class="text-sm">Left Days</td>
                                                <td class="text-sm">
                                                    <td class="text-sm">
