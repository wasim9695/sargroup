...
<div className="mb-3">
<input type="text" className="form-control" placeholder="Company Name" aria-label="Boutique Code"/>
</div>
<label>Boutique Name:</label>
<div className="mb-3">
<input type="text" className="form-control" placeholder="Company Name" aria-label="Boutique Name"/>
</div>
