...
<div className="mb-3">
<input type="text" className="form-control" placeholder="VTC Vendor Code" aria-label="VTC Vendor Code"/>
</div>
<label>Client Group Name:</label>
<div className="mb-3">
<input type="text" className="form-control" placeholder="Client Group Name" aria-label="Client Group Name"/>
</div>
