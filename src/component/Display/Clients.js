...
<div className="mb-3">
<input type="text" className="form-control" placeholder="Client Code" aria-label="Client Code"/>
</div>
<label>Client Name:</label>
<div className="mb-3">
<input type="text" className="form-control" placeholder="Client Name" aria-label="Client  Name"/>
</div>
