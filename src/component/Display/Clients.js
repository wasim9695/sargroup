...
import { getCountryList, getStateList, getCityList, saveCLient,
    getClientList, getClientGroupList } from "../../service/AllApiData-service";
    const  Clients = () => {
    ...
    const [client_group_id, setClient_group_id] = useState("");
   ...
   const getAllCountry = async () => {
    ...
    const getAllCity = async () => {
      ...
      const getAllClientsGroupsList = async () => {
        const data = { page:page, limit:'25', search:'' };
         await getClientGroupList(data).then(res => {
   ...
   const displayedItems = getClientLists.slice(startIndex, startIndex + itemsPerPage);


      const save = async () => {
        const data = {client_group_id,client_name,client_code,address_line1,address_line2,
         ...
         await saveCLient(data).then(res => {
            console.log(res);
        ...
        <div>
            ...
            <div className="col-md-12">
                <div className="row" hidden={hideTabs}>
                    ...
                    <h3 className="font-weight-bolder text-info text-gradient text-center display-7">Client</h3>
                    <div className="row">
...
<div className="mb-3">
<select onChange={e => setClient_group_id(e.target.value)} name="client_group_id" 
value={client_group_id} className='form-control'>
    <option>Select</option>
    {getClientGoupLists.map((items)=>(
...
<div className="mb-3">
<input type="text" onChange={e => setClient_code(e.target.value)} name="client_code" 
value={client_code} className="form-control" placeholder="Client Code" aria-label="Client Code"/>
</div>
<label>Client Name:</label>
<div className="mb-3">
<input type="text" onChange={e => setClient_name(e.target.value)} name="client_name" 
value={client_name} className="form-control" placeholder="Client Name" aria-label="Client  Name"/>
</div>
...
<button  hidden={hide} type="button" className="btn bg-gradient-info w-100 mt-4 mb-0">Update</button>
