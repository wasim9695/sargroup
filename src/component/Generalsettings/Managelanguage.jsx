                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header pb-0">
                            <div class="d-lg-flex">
                                <h2>Manage Langauge</h2>
                                <div class="ms-auto my-auto mt-lg-0 mt-4">
                                    <div class="ms-auto my-auto">
                                        <Link to="/admin/Addlanguage">
                                ...
                                <table class=" tab1 table table-bordered table table-flush" id="products-list">
                                    <thead class="thead-light">
                                        <tr>
                                            ...
                                            <th>Langauge Name</th>
                                            <th>Langauge Symbol</th>
                                            <th>Default</th>
                                            <th>Flag</th>
                                            <th>Language Status</th>
                                            <th>Words Translations</th>
                                            <th>Action</th>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="text-sm">Country
                                            </td>
                                            <td class="text-sm">Langauge Name
                                            </td>
                                            <td class="text-sm">Langauge Symbol
                                            </td>
                                            <td class="text-sm">Defualt
                                            </td>
                                            <td class="text-sm">Flag
                                            </td>
                                            <td class="text-sm">Langiage Status</td>
                                            <td class="text-sm">Words Translation
                                            </td>
                                            <td class="text-sm">
                                                ...
                                                <a href="javascript:;" class="mx-3" data-bs-toggle="tooltip" data-bs-original-title="Edit product">
                                                    <i class="fas fa-delete-edit text-secondary"></i>
                                                </a>
                                            </td>
                                        </tr>
                                        <tr></tr>
