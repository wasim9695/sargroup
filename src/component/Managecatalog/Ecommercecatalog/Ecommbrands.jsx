                                    ...
                                    <table class=" tab1 table table-bordered table table-flush" id="products-list">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="text-sm">Brand  Name</td>
                                                <td class="text-sm">Category Name</td>
                                                <td class="text-sm">Sub-Category Name</td>
                                                <td class="text-sm">Child-Category Name</td>
                                                <td class="text-sm">Website</td>
                                                <td class="text-sm">Image(LOGO)</td>
                                                <td class="text-sm">Top Brand</td>
