                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header pb-0">
                                <div class="d-lg-flex">
                                    <h2>Category GST & Govt Code</h2>
                                    <div class="ms-auto my-auto mt-lg-0 mt-4">
                                        <div class="ms-auto my-auto">
                                            <Link to="/admin/Addgovt">
                                    ...
                                    <table class=" tab1 table table-bordered table table-flush" id="products-list">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="text-sm">Sub-Category</td>
                                                <td class="text-sm">Child-Category</td>
                                                <td class="text-sm">GST</td>
                                                <td class="text-sm">Price Range</td>
                                                <td class="text-sm">GOVT Code</td>
