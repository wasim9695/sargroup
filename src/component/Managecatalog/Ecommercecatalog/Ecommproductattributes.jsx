...
function Ecommproductattributes() {
    return (
        <div>
                                    ...
                                    <table class=" tab1 table table-bordered table table-flush" id="products-list">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="text-sm">Select Type(Unit)</td>
...
export default Ecommproductattributes
