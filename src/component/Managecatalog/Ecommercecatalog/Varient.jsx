...
function Varient() {
    return (
        <div>
            <div>
                <h2>E-Commerce Varient Product</h2>
                <br></br>
                <div className='row'>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <label class="mt-4">Company Commission (%)</label>
                                    <input class="form-control" type="text" value="" placeholder=''/>
                                </div>
                                <div class="col-md-12">
                                    <label class="mt-4">Company Commission(Rs.)</label>
                                    <input class="form-control" type="text" value="" placeholder=''/>
                                </div>
                                <div class="col-md-12">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            <label class="mt-4">Varient Name</label>
                                            <input class="form-control" type="text" />
                                        </div>
                                        <div class="col-12">
                                            <label class="mt-4">Varient Size</label>
                                            <input class="form-control" type="number" value="00" />
                                        </div>
                                        <div class="col-12">
                                            <label class="mt-4">Varient Type</label>
                                            <input class="form-control" type="text" />
                                        </div>
                                        ...
                                        <div class="col-12">
                                            <label class="mt-4" > Varient Unit Price</label>
                                            <input class="form-control" type="number" value="00" />
                                        </div>
                                        <div class="col-md-12">
                                            <label class="mt-4">User Sponsor Commission</label>
                    ...
                    <div className='row mt-4'>
                        <div class="col-sm-12">
                            <div class="card dpn">
                                <div class="card-body">
                                    <h5 class="font-weight-bolder">Product Varients List</h5>
                                    <div className='row'>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td class="text-sm">
                                                            ...
                                                            <a href="javascript:;" data-bs-toggle="tooltip" data-bs-original-title="Preview product">
                                                                <i class="fas fa- text-secondary"></i>
                                                            </a>
