                        ...
                        <div class="card-body">
                            ...
                            <div class="col-md-12">
                                ...
                                <select class="form-control" id="exampleFormControlSelect1">
                                    ...
                                    <option>User Rightside Bar</option>
                                    <option>Website</option>
                                </select>
                            </div>
                            <div class="col-md-12">
                                <label class="mt-4">Select Sider No</label>
                                <input class="form-control" type="text" value="" placeholder=''/>
                            </div>
                            <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                <label class="mt-4">Image/Video</label>
                                <input class="form-control" type="text" value="" placeholder=''/>
                            </div>
...
export default Addnotofication
