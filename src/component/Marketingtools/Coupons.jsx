                                ...
                                <table class=" tab1 table table-bordered table table-flush" id="products-list">
                                    <thead class="thead-light">
                                        <tr>
                                            ...
                                            <th>Discount</th>
                                            <th>Minimum Shopping Amount</th>
                                            <th>Maximum Shopping Amount
                                            </th>
                                            <th>Users Limit</th>
                                            <th>Start Date</th>
                                            <th>End Date</th>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="text-sm">Coupon
                                            </td>
                                            <td class="text-sm">Type of Discount
                                            </td>
                                            <td class="text-sm">Discount
                                            </td>
                                            <td class="text-sm">Minimum Shopping Amount</td>
                                            <td class="text-sm">Maximum Shopping Amount
                                            </td>
                                            <td class="text-sm">Users Limit</td>
