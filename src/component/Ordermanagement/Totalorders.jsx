                                ...
                                <div className='col-md-3 gt'>
                                    <div class="form-group">
                                        <select class="form-control" id="exampleFormControlSelect1">
                                            ...
                                            <option value="3">Return & Replacement</option>
                                            <option value="3">Customer Not Reachable</option>
                                            <option value="3">Customer Refused to accept Order</option>
                                        </select>
                                    </div>
                                </div>
