                                    ...
                                    <table class=" tab1 table table-bordered table table-flush" id="products-list">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="text-sm">Game Membership</td>
                                                <td class="text-sm">Sales</td>
                                                <td class="text-sm">Unit Price</td>
                                                <td class="text-sm">Company Margin</td>
