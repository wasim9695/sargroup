                                    ...
                                    <table class=" tab1 table table-bordered table table-flush" id="products-list">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="text-sm">Seller No</td>
                                                <td class="text-sm">Wallet</td>
                                                <td class="text-sm">Country</td>
                                                <td class="text-sm">KYC & Legal Status</td>
                                                <td class="text-sm">Bank Details</td>
                                                <td class="text-sm">Pancard No</td>
                                                <td class="text-sm">Transferred Amount</td>
                                                <td class="text-sm">Seller Payout Note</td>
                                                <td class="text-sm">
...
export default Sellerpayoutreports
