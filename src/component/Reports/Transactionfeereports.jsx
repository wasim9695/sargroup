...
function Transactionfeereports() {
    return (
        <div>
                                    ...
                                    <table class=" tab1 table table-bordered table table-flush" id="products-list">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="text-sm">Invoice No</td>
                                                <td class="text-sm">User Name</td>
                                                <td class="text-sm">Net Amount</td>
                                                <td class="text-sm">Tax Type</td>
                                                <td class="text-sm">Tax(%)</td>
                                                <td class="text-sm">Tax Amount</td>
                                                <td class="text-sm">Final Price</td>
                                                <td class="text-sm">Packaging Charges</td>
                                                <td class="text-sm">Shipping Charges</td>
...
export default Transactionfeereports
