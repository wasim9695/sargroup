                                    ...
                                    <table class=" tab1 table table-bordered table table-flush" id="products-list">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="text-sm">Withdrawl No</td>
                                                <td class="text-sm">User Id</td>
                                                <td class="text-sm">User No</td>
                                                <td class="text-sm">Commission Details</td>
                                                <td class="text-sm">Country</td>
                                                <td class="text-sm">KYC Status</td>
                                                <td class="text-sm">Bank Details</td>
                                                <td class="text-sm">Pancard No</td>
                                                <td class="text-sm">Admin Fee</td>
                                                <td class="text-sm">Admin Fee Amount</td>
                                                <td class="text-sm">TDS</td>
                                                <td class="text-sm">TDS Amount</td>
                                                <td class="text-sm">Transferred Amount</td>
                                                <td class="text-sm">Payout Note</td>
                                                <td class="text-sm">
...
export default Userpayoutreports
