                                ...
                                <div class="d-lg-flex">
                                    ...
                                    <div class="ms-auto my-auto mt-lg-0 mt-4">
                                        <div class="ms-auto my-auto">
                                            ...
                                            <button class="btn btn bg-gradient-secondary btn-sm export mb-0 mt-sm-0 mt-1" data-type="csv" type="button" name="button"style={
                                                    {marginLeft: "10px"}
                                            }>
                                                PDF
                                            </button>
