                                    ...
                                    <table class=" table table-bordered table table-flush" id="products-list">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="text-sm">
                                                    <select class="form-select" aria-label="Default select example">
                                                        <option selected><span class="badge badge-info badge-sm">Published</span></option>
                                                        <option selected><span class="badge badge-info badge-sm">Un-Published</span></option>
                                                    </select>
                                                </td>
                                                <td class="text-sm">
                                                    <span class="badge badge-info badge-sm">Pending</span> <br /> <span class="badge badge-success badge-sm">Approved</span> <br /> <span class="badge badge-danger badge-sm">Rejected</span></td>
                                                ...
                                                <td class="text-sm">Discount Type : Flat /(%)</td>
