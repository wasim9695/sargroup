                                    ...
                                    <table class=" tab1 table table-bordered table table-flush" id="products-list">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="text-sm">Campaign Position</td>
                                                <td class="text-sm">Image/Banner</td>
                                                <td class="text-sm">Final Price</td>
                                                <td class="text-sm">From Date</td>
                                                <td class="text-sm">To Date</td>
                                                <td class="text-sm">Validity Days</td>
                                                <td class="text-sm">Status</td>
                                                <td class="text-sm">Download</td>
