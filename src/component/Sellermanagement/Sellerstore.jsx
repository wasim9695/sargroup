                                    ...
                                    <table class=" tab1 table table-bordered table table-flush" id="products-list">
                                        <thead class="thead-light">
                                            <tr>
                                                ...
                                                <th>Own Brands</th>
                                                <th>Brands</th>
                                                <th>Total Products Published</th>
                                                <th>Total Products Applied</th>
                                                <th>Store Status</th>
                                                <th>A/C Status</th>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="text-sm"> Total Categories</td>
                                                <td class="text-sm">Own Brands</td>
                                                <td class="text-sm"> Brands</td>
                                                <td class="text-sm"> Total Products Published</td>
                                                <td class="text-sm"> Total Products Applied</td>
                                                <td class="text-sm"> <td class="text-sm"> <select class="form-select" aria-label="Default select example" style={{ width: "130px" }}>
                                                ...
                                                <td class="text-sm"><td class="text-sm"> <span class="badge badge-info badge-sm">Pending</span>
                                                    <br />
                                                    <span class="badge badge-success badge-sm">Approved</span> <br /> <span class="badge badge-danger badge-sm">Rejected</span></td> </td>
                                                <td class="text-sm">
