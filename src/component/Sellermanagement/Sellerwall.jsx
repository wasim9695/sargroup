                                    ...
                                    <table class=" tab1 table table-bordered table table-flush" id="products-list">
                                        <thead class="thead-light">
                                            <tr>
                                                ...
                                                <th>Store Status</th>
                                                <th>Total Wallet</th>
                                                <th>Withdrawl Req Approved</th>
                                                <th>Total Withdrawls</th>
                                                <th>Total Available Amount</th>
                                                <th>Withdrawl Request</th>
                                                <th>Withdrawl Req Amount</th>
                                                <th>Withdrawl Req Rejected</th>
                                                <th>Withdrawl Req Amount</th>
                                                <th>KYC Status</th>
                                                <th>A/C Status</th>
                                                <th>Action</th>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="text-sm">Total Wallet</td>
                                                <td class="text-sm">Withdrawl Req Approved</td>
                                                <td class="text-sm">Total Withdrawls</td>
                                                <td class="text-sm">Total Available Amount</td>
                                                <td class="text-sm">Withdrawl Request</td>
                                                <td class="text-sm">Woithdrawl Req Amount</td>
                                                <td class="text-sm">Withdrawl Req Rejected</td>
                                                <td class="text-sm">Withdrawl Req Amount</td>
                                                <td class="text-sm">Withdrawl Req Rejected</td>
                                                <td class="text-sm">KYC Status</td>
