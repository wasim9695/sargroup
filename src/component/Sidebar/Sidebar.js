      ...
      <hr className="horizontal dark mt-0" />
        ...
        >
          <ul className="navbar-nav">
            ...
            <li className="nav-item" style={{borderTop:'none'}}>
              <a
            ...
            <li className="nav-item" style={{borderTop:'none'}}>
              ...
              <div className="collapse " id="karg">
                <ul className="nav ms-2 ps-3">

            <li className="nav-item">
            <Link className="nav-link " to="admin/karigarlist">
