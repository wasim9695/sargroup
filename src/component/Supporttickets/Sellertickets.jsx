                                    ...
                                    <table class=" tab1 table table-bordered table table-flush" id="products-list">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="text-sm">Ticket No</td>
                                                <td class="text-sm">User Id</td>
                                                <td class="text-sm">User Name</td>
                                                <td class="text-sm">Subject</td>
                                                ...
                                                <td class="text-sm">IpAddress,OS,Device</td>
                                                <td class="text-sm">Staff ID</td>
                                                <td class="text-sm">Staff Name</td>
                                                <td class="text-sm">Staff Role</td>
                                                <td class="text-sm">
                                                    Status</td>
                                                <td class="text-sm">
