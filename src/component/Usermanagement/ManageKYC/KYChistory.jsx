                                    ...
                                    <table class=" tab1 table table-bordered table table-flush" id="products-list">
                                        <thead class="thead-light">
                                            <tr>
                                                ...
                                                <th>Sponsor Name</th>
                                                <th>Country</th>
                                                <th>KYC Doc Details</th>
                                                <th>KYC Doc Img</th>
                                                <th>ORG Certificate Details</th>
                                                <th>ORG Certificate Img</th>
                                               <th>Status</th>
                                                <th>Remarks</th>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="text-sm">DOC Name <br />
                                                <span>DOC No</span>
                                                </td>
                                                <td class="text-sm">KYC Doc Img</td>
                                                <td class="text-sm">Registered Year <br />
                                                <span>ORG Certificate No</span></td>
                                                <td class="text-sm">Org Certificate Img</td>
                                                <td class="text-sm">KYC Status -  <span class="badge badge-success badge-sm">
                                                        Pending
                                                    </span> <br />
                                                <span>Acc Status</span> -  <span class="badge badge-success badge-sm">
                                                        Approved
                                                    </span></td>
