                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header pb-0">
                                <div class="d-lg-flex">
                                    <h2>Organisation Users History</h2>
                                    ...
                                    <table class=" tab1 table table-bordered table table-flush" id="products-list">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="text-sm">Authority Name</td>
                                                <td class="text-sm">Role In Org</td>
                                                ...
                                                <td class="text-sm">A/C Status
                                                <br/>
                                                <span>KYC Status</span>
                                                </td>
                                                <td class="text-sm">KYC Status</td>
                                                <td class="text-sm">Last Uodated Date</td>
