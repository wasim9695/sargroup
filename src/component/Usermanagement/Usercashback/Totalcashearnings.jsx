                                    ...
                                    <table class=" tab1 table table-bordered table table-flush" id="products-list">
                                        <thead class="thead-light">
                                            <tr>
                                                ...
                                                <th>Cashback Commisison</th>
                                                <th>Cashback Commission Status (Pending)</th>
                                                <th>Cashback Commission Status(Available)</th>
                                                <th>Action</th>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="text-sm">Cashback Commission Status (Pending)</td>
                                                <td class="text-sm">Cashback Commission Status (Available)</td>
...
export default Totalcashearnings
