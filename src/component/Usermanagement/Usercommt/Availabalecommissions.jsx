...
function Availabalecommissions() {
    return (
        <div>
                                    ...
                                    <table class=" tab1 table table-bordered table table-flush" id="products-list">
                                        <thead class="thead-light">
                                            <tr>
                                                ...
                                                <th>User Name</th>
                                                <th>Team</th>
                                                <th>T Sponsor Commission</th>
                                                <th>T AuR Commission</th>
                                                <th>Av Membership Pro-Commission</th>
                                                <th>Av Pro-commission</th>
                                                <th>Av Sponsor Commission</th>
                                                <th>Action</th>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="text-sm">T Sponsor Commission</td>
                                                <td class="text-sm">T Aur Commission</td>
                                                <td class="text-sm">Av Membership Pro-Commission</td>
                                                <td class="text-sm">Av Pro-Commission</td>
                                                <td class="text-sm">Av Sponsor Commission</td>
...
export default Availabalecommissions
