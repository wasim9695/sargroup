                                    ...
                                    <table class=" tab1 table table-bordered table table-flush" id="products-list">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="text-sm"> <span class="badge badge-danger badge-sm">
                                                            View
                                                        </span></td>
                                                <td class="text-sm">Req.Members</td>
                                                <td class="text-sm">Joined Members</td>
                                                <td class="text-sm">Membership Status</td>
