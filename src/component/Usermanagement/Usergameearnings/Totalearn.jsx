                                    ...
                                    <table class=" tab1 table table-bordered table table-flush" id="products-list">
                                        <thead class="thead-light">
                                            <tr>
                                                ...
                                                <th>User Name</th>
                                                <th>Total Orders</th>
                                                <th>Membership Completed</th>
                                                <th>Membership Pending</th>
                                                <th>Total Req Members</th>
                                                <th>Total Joined Members</th>
                                                <th>Total Game Comm Earned</th>
                                                <th>Total Game Comm Earn Left</th>
                                                <th>Action</th>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="text-sm">Total Orders</td>
                                                <td class="text-sm">Membership Completed</td>
                                                <td class="text-sm">Membership Pending</td>
                                                <td class="text-sm">Total Req Members</td>
                                                <td class="text-sm">Total Joined Members</td>
                                                <td class="text-sm">Total Game Comm Earned</td>
                                                <td class="text-sm">Total Game Comm Earn Left</td>
