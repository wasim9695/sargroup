                                    ...
                                    <table class=" tab1 table table-bordered table table-flush" id="products-list">
                                        <thead class="thead-light">
                                            <tr>
                                                ...
                                                <th>Team Details</th>
                                                <th>Total Orders</th>
                                                <th>Total Team Income</th>
                                                <th>Available Team Income</th>
                                                <th>Action</th>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <Link to="/admin/Usertree">
                                                    <td class="text-sm">
                                                        <span class="badge badge-primary badge-xl">View</span>
                                                    </td>
                                                </Link>
                                                ...
                                                <td class="text-sm">Required Numbers
                                                    <br/>
                                                    <span>Joined Numbers</span>
                                                    <br/>
                                                    <span>Left</span>
                                                </td>
                                                <td class="text-sm">Total Orders</td>
                                                <td class="text-sm">Total Team Income</td>
                                                <td class="text-sm">Available Team Income</td>
                                                <td class="text-sm">
...
export default Usernetworkbonus
