                                    ...
                                    <table class=" tab1 table table-bordered table table-flush" id="products-list">
                                        <thead class="thead-light">
                                            <tr>
                                                ...
                                                <th>User ID</th>
                                                <th>User Name</th>
                                                <th>User Network Team Members</th>
                                                <th>Total Products purchased</th>
                                                <th>Products Delivered</th>
                                                <th>T Products Business</th>
                                                <th>Action</th>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="text-sm">User Network Team Members</td>
                                                <td class="text-sm">Total Products purchased</td>
                                                <td class="text-sm">Products Delivered</td>
                                                <td class="text-sm">T Products Business</td>
                                                <td class="text-sm">
