                                    ...
                                    <table class=" tab1 table table-bordered table table-flush" id="products-list">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="text-sm">Grand Total Price</td>
                                                <td class="text-sm">Recieved Points</td>
                                                <td class="text-sm">Point Status</td>
...
export default Orderwisepoints
