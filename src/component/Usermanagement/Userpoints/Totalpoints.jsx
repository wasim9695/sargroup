                                    ...
                                    <table class=" tab1 table table-bordered table table-flush" id="products-list">
                                        <thead class="thead-light">
                                            <tr>
                                                ...
                                                <th>Total Recieved Points</th>
                                                <th>Total Used Points</th>
                                                <th>Total Points Available</th>
                                                <th>Total Points Expired</th>
                                                <th>Action</th>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="text-sm">Total Recieved Points</td>
                                                <td class="text-sm">Total Used Points</td>
                                                <td class="text-sm">Total Points Available</td>
                                                <td class="text-sm">Total Points Expired</td>
