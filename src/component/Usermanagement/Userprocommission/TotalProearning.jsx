                                    ...
                                    <table class=" tab1 table table-bordered table table-flush" id="products-list">
                                        <thead class="thead-light">
                                            <tr>
                                                ...
                                                <th>Total Admin Fee % (Wallet)</th>
                                                <th>Total Admin Fee ₹ </th>
                                                <th>Total Pro-commission (%)</th>
                                                <th>Total Pro-commission (₹)</th>
                                                <th>Action</th>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="text-sm">Total Order</td>
                                                <td class="text-sm">Total Qty</td>
                                                <td class="text-sm">Total Final Amount</td>
                                                <td class="text-sm"> Grand Total Amount</td>
                                                <td class="text-sm">Total Admin Fee % (Wallet)</td>
                                                <td class="text-sm">Total Admin Fee ₹</td>
                                                <td class="text-sm">Total Pro-commission (%)</td>
                                                <td class="text-sm">Total Pro-commission (₹)</td>
                                                <td class="text-sm">
...
export default TotalProearning
