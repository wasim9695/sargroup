                                    ...
                                    <table class=" tab1 table table-bordered table table-flush" id="products-list">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="text-sm">Grand Total
                                                </td>
                                                <td class="text-sm">Membership Name</td>
                                                <td class="text-sm">Level No</td>
                                                <td class="text-sm">Shopping Amount</td>
                                                <td class="text-sm">
                                                    <span class="badge badge-info badge-sm">Used</span>
                                                    <br></br>
...
export default Orderwiseshopamount
