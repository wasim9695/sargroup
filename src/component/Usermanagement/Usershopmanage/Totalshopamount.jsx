                                    ...
                                    <table class=" tab1 table table-bordered table table-flush" id="products-list">
                                        <thead class="thead-light">
                                            <tr>
                                                ...
                                                <th>Shopping Amount Available</th>
                                                <th>Shopping Amount Used</th>
                                                <th>Action</th>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="text-sm">Total Final Price</td>
                                                <td class="text-sm">
                                                    Grand Total</td>
                                                <td class="text-sm">Total Memberships</td>
                                                <td class="text-sm">Total Levels</td>
                                                <td class="text-sm">Total Shopping Amount</td>
                                                <td class="text-sm">Shopping Amount Available</td>
                                                <td class="text-sm">Shopping Amount Used</td>
                                                <td class="text-sm">
...
export default Totalshopamount
