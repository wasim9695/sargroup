                                    ...
                                    <table class=" tab1 table table-bordered table table-flush" id="products-list">
                                        <thead class="thead-light">
                                            <tr>
                                                ...
                                                <th>Overall Grand Total Amount</th>
                                                <th>Sponsor E Commission</th>
                                                <th>Sponsor E Commission(Pending)</th>
                                                <th>Sponsor E Commission(Available)</th>
                                                <th>Action</th>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="text-sm">Total Final Amount</td>
                                                <td class="text-sm">Overall Grand total Amount</td>
                                                <td class="text-sm">Sponsor E Commission</td>
                                                <td class="text-sm">Sponsor E Commission (Pending)</td>
                                                <td class="text-sm">Sponsor E Commission (Available)</td>
...
export default Totalseearnings
