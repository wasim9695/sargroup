                                    ...
                                    <table class=" tab1 table table-bordered table table-flush" id="products-list">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="text-sm">Team Income (%)</td>
                                                <td class="text-sm">Team Income/Level</td>
                                                <td class="text-sm">Team Income Status</td>
                                                <td class="text-sm">UL Downline (%)</td>
                                                <td class="text-sm">UL Downline amount</td>
                                                <td class="text-sm">UL Downline Status</td>
                                                <td class="text-sm">
...
export default Userteamproductsales
