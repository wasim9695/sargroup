...
function Userteambonussubscrip() {
    return (
        <div>
                                    ...
                                    <table class=" tab1 table table-bordered table table-flush" id="products-list">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="text-sm">Membership Name</td>
                                                <td class="text-sm">Monthly</td>
                                                ...
                                                <td class="text-sm">Points Validity</td>
                                                <td class="text-sm">
...
export default Userteambonussubscrip
