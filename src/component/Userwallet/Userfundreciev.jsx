                                    ...
                                    <table class=" tab1 table table-bordered table table-flush" id="products-list">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="text-sm">Amount Transferred</td>
                                                <td class="text-sm">Reciever Name</td>
                                                <td class="text-sm">Reciever id</td>
                                                <td class="text-sm">Sender Name</td>
                                                <td class="text-sm">Sender Id</td>
                                                <td class="text-sm">Ip Adress</td>
